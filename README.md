...
- [EpiGame](https://github.com/principelab/epigame-core) — Framework for identification of epilepsy surgery targets, by network analysis of intracranial EEG data.
- [xPEC](https://github.com/principelab/multipec-core) — xPEC tool for data-driven mapping of neural representations from neural activity data (applied to human EEG data & convolutional neural networks). [biorXiv](https://doi.org/10.1101/2025.11.18.688989)
